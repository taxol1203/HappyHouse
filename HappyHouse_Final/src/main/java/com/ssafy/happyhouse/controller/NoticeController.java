...
public class NoticeController {
    ...
    @GetMapping("/{title}/{content}/{writer}")
	public ResponseEntity<String> writeBoard(@PathVariable String title, @PathVariable String content, @PathVariable String writer) {
